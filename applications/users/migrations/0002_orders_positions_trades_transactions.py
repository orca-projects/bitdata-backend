    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_order_id', models.CharField(db_column='clientOrderId', max_length=255)),
                ('cum_base', models.CharField(db_column='cumBase', max_length=255)),
                ('executed_qty', models.CharField(db_column='executedQty', max_length=255)),
                ...
                ('position_side', models.CharField(db_column='positionSide', max_length=255)),
                ('status', models.CharField(db_column='status', max_length=255)),
                ('stop_price', models.CharField(blank=True, db_column='stopPrice', max_length=255, null=True)),
                ...
                ('time_in_force', models.CharField(db_column='timeInForce', max_length=255)),
                ('type', models.CharField(db_column='type', max_length=255)),
                ('activate_price', models.CharField(blank=True, db_column='activatePrice', max_length=255, null=True)),
                ('price_rate', models.CharField(blank=True, db_column='priceRate', max_length=255, null=True)),
                ('update_time', models.BigIntegerField(db_column='updateTime')),
                ('working_type', models.CharField(db_column='workingType', max_length=255)),
                ('price_protect', models.BooleanField(db_column='priceProtect', default=False)),
                ('price_match', models.CharField(db_column='priceMatch', default='NONE', max_length=255)),
                ('self_trade_prevention_mode', models.CharField(db_column='selfTradePreventionMode', default='NONE', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commission', models.CharField(db_column='commission', max_length=255)),
                ('commission_asset', models.CharField(db_column='commissionAsset', max_length=255)),
                ...
                ('realized_pnl', models.CharField(db_column='realizedPnl', max_length=255)),
                ('side', models.CharField(db_column='side', max_length=255)),
                ('position_side', models.CharField(db_column='positionSide', max_length=255)),
                ('symbol', models.CharField(db_column='symbol', max_length=255)),
                ('time', models.BigIntegerField(db_column='time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('symbol', models.CharField(db_column='symbol', max_length=255)),
                ('income_type', models.CharField(db_column='incomeType', max_length=255)),
